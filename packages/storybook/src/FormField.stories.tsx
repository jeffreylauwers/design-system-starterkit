...
import { FormField, TextInput, TextArea, CheckboxGroup, CheckboxOption } from '@dsn/components-react';
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
      ...
      <div>
        ...
        >
          <TextInput id="email-desc" type="email" placeholder="naam@voorbeeld.nl" />
        </FormField>
      </div>

      <div>
        <h3 style={{ marginBlockEnd: '1rem' }}>With optional suffix</h3>
        <FormField label="Telefoonnummer" htmlFor="phone" labelSuffix="(niet verplicht)">
          <TextInput id="phone" type="tel" placeholder="06-12345678" width="sm" />
        </FormField>
      </div>
      ...
      <div>
        ...
        >
          <TextInput id="password-error" type="password" invalid placeholder="Voer wachtwoord in" />
        </FormField>
      </div>

      <div>
        <h3 style={{ marginBlockEnd: '1rem' }}>With status (default variant - character counter)</h3>
        <FormField
          label="Bio"
          htmlFor="bio-status"
        ...
        >
          <TextArea id="bio-status" rows={4} placeholder="Vertel iets over jezelf..." />
        </FormField>
      </div>
      ...
      <div>
        ...
        >
          <TextInput id="password-positive" type="password" value="StrongP@ssw0rd!" readOnly />
        </FormField>
      </div>
      ...
      <div>
        <h3 style={{ marginBlockEnd: '1rem' }}>Complete example (description + error + status)</h3>
        <FormField
        ...
        >
          <TextInput id="password-complete" type="password" invalid value="Weak" readOnly />
        </FormField>
      </div>

      <div>
        <h3 style={{ marginBlockEnd: '1rem' }}>With CheckboxGroup</h3>
        <FormField label="Interesses" description="Selecteer minimaal één interesse">
          <CheckboxGroup>
      ...
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <FormField label="Telefoonnummer" htmlFor="phone2">
            <TextInput id="phone2" type="tel" placeholder="06-12345678" width="sm" />
          </FormField>
          <FormField label="E-mailadres" htmlFor="email2">
            <TextInput id="email2" type="email" placeholder="naam@voorbeeld.nl" width="md" />
          </FormField>
          <FormField label="Website" htmlFor="website">
            <TextInput id="website" type="url" placeholder="https://voorbeeld.nl" width="lg" />
          </FormField>
        </div>
      </div>
    </div>
