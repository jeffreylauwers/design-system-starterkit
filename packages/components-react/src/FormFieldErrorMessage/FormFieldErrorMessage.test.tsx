...
describe('FormFieldErrorMessage', () => {
  it('renders children', () => {
    render(<FormFieldErrorMessage>Dit veld is verplicht.</FormFieldErrorMessage>);
  ...
  it('always has base dsn-form-field-error-message class', () => {
    ...
    expect(screen.getByText('Error')).toHaveClass('dsn-form-field-error-message');
  });

  it('applies custom className', () => {
    render(<FormFieldErrorMessage className="custom">Error</FormFieldErrorMessage>);
  ...
  it('spreads additional HTML attributes', () => {
    render(<FormFieldErrorMessage id="email-error" data-testid="error">Error message</FormFieldErrorMessage>);
  ...
  describe('icon', () => {
    it('shows icon by default', () => {
      const { container } = render(<FormFieldErrorMessage>Error</FormFieldErrorMessage>);
    ...
    it('hides icon when showIcon is false', () => {
      const { container } = render(<FormFieldErrorMessage showIcon={false}>Error</FormFieldErrorMessage>);
      const icon = container.querySelector('.dsn-icon');
      expect(icon).not.toBeInTheDocument();
    });

    it('shows icon when showIcon is true', () => {
      const { container } = render(<FormFieldErrorMessage showIcon={true}>Error</FormFieldErrorMessage>);
      const icon = container.querySelector('.dsn-icon');
      expect(icon).toBeInTheDocument();
    });

    it('renders both icon and error text', () => {
      const { container } = render(<FormFieldErrorMessage>Dit veld is verplicht</FormFieldErrorMessage>);
